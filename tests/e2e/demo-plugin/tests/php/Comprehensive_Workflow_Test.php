...
class Comprehensive_Workflow_Test extends E2E_Test_Case {
	...
	public function test_all_demo_imports_complete_without_leaking_state(): void {
		...
		$this->run_sync_to_completion( Product_CSV_Import::SYNC_NAME, $csv_group );
		$this->run_sync_to_completion( Lead_JSON_Import::SYNC_NAME, $json_group );
		$this->run_sync_to_completion( Product_Excel_Import::SYNC_NAME, $excel_group );
		$this->run_sync_to_completion( Product_API_Import::SYNC_NAME, $api_group );
