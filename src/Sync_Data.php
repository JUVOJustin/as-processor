...
trait Sync_Data {
	...
	public function get_sync_data_name(): string {
		...
		// @phpstan-ignore-next-line The trait is also used in tests without get_sync_group_name().
		if ( empty( $this->sync_data_name ) && is_callable( array( $this, 'get_sync_group_name' ) ) ) {
